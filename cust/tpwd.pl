...
&wgFilter::SkipTag('<div id="header">', \@lines);
&wgFilter::SkipTag('<div id="toplinks">', \@lines);
&wgFilter::SkipTag('<div id="footer">', \@lines);
&wgFilter::SkipSection('Please send comments, suggestions','</noscript>',\@lines);

my @phrases = ('Texas Parks & Wildlife','Texas Parks & Wildlife Department',
	'Texas Parks and Wildlife','Texas Parks and Wildlife Department',
	'Parks and Wildlife', 'Parks & Wildlife');
&wgFilter::KillPhrases(\@phrases, \@lines);
