/********
 * $Id: htuml2txt.lex,v 1.2 2003/09/02 17:46:40 golda Exp $
 * $Log: htuml2txt.lex,v $
 * Revision 1.2  2003/09/02 17:46:40  golda
 * Moving repository; adding language templates for easier update, adding Bulgarian
 *
 * Revision 1.1.1.1  2003/08/24 20:16:07  golda
 * Moving CVS!
 *
 * Revision 1.1  2000/11/28 03:44:07  golda
 * Checking in contrib area, install files, standard lib files, and new file wgTextMsgs.pm which tries to keep all text messages in one file for easier translation.
 *
